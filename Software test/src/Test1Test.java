...
public class Test1Test {
  ...
  public void test1() {
    ...
    driver.manage().window().setSize(new Dimension(916, 824));
    ...
    driver.findElement(By.cssSelector("#\\34tmAkl_NkBqtD8L4-yuSZA .\\_cropped-image-link_style_fluidLandscapeImage__3eTVC")).click();
  }
}
